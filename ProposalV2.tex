...
This section will contain a brief analysis of previous game-playing AIs, referred to in this report as `agents', that utilise reinforcement learning. Agents play the game as a human would, either as an opponent or a replacement. Most examples come from the recent game AI competitions, however some can be found in commercial games. Table \ref{tab:agents} summarises some examples. 
...
\begin{itemize}
	\item Many approaches use elements of traditional Game AI (A*, BTs...).
