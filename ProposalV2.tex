...
Despite the lack of commercial success, video games can act as great benchmark for Reinforcement Learning AI. They are designed to challenge humans, and therefore will challenge AI methods. Games generally have some level of learning curve associated with playing them (as a human). Also, games require quick reactions to stimulus, something not true of traditional AI challenges such as board games. Lastly, most game have some notion of scoring suitable for a fitness function and they are generally accessible to students, academic and the general public alike. \cite[p.~9]{panorama} \cite[p.~1]{marioaicomp} \cite[p.~2]{2012the}
...
\begin{table}[t]
  ...
  \begin{center} \small
    ...
    \multicolumn{3}{| l |}{\emph{\textbf{ Genetic Algorithms (GAs)}}} \Tstrut \\ \hline
    ...
    A crossover heavy GA to evolve expression tree.
    \\ \hline
    ...
    \multicolumn{3}{| l |}{\emph{\textbf{ General Evolutionary Methods}}} \Tstrut \\ \hline
    ...
    \multicolumn{3}{| l |}{\emph{\textbf{ General Reinforcement Learning}}} \Tstrut \\ \hline
    ...
    Reinforcement learning to tune parameters to potential field and A* search.
    \\ \hline
  ...
  \end{center}
  \end{adjustwidth}
  \caption{This table summarises agent based approaches to Game AI, utilising learning}
  \label{tab:agents}
\end{table}
...
[More specific on REALM evolutions and mention Agent Smith, which also evolved a ruleset (fitness function tuned to play style)]
...
\subsection*{June 10th -- July 10st}
\begin{description}
	\item[3 days] Integration of the existing Java codebase with the Scala language.
	\item[14 days] Rule set interpretation testing and implementation, including the creation of a hand-made agent.
	\item[14 days] Evolutionary Methods library integration and learning set-up.
\end{description}
