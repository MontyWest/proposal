...
\subsubsection{Traditional Game AI}
...
[Not sure this is needed anymore, only mentioned in table briefly]
...
\begin{table}[t]
  ...
  \begin{center} \small
    ...
    \textbf{The Simulated Car Racing Competition} Competitors enter drivers, that undergo races against other entrants which include qualifying and multi-car racing. The competition encourages the use of learning techniques (but doesn't ban non-learning agents). \cite{scrc} 
     \\ \thickhline
    ...
    \textbf{The Starcraft AI Competition} Competitors play against each other in a 1 on 1 knockout style tournament. Implementing an agent involves solving both micro objectives, such as path-planning, and macro objectives, such as base progression. \cite{starcomp}
     \\ \thickhline
